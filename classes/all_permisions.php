...
class all_permisions extends table_sql {
    ...
    function col_selected($values) {
        if (!$this->is_downloading()) {
            $editlink = "<a href=\"addnewpermission.php?cid=$values->id\">" . get_string('edit', 'local_saml_site') . '</a>';
            $deletelink = "<a href=\"addnewpermission.php?cid=$values->id&delete=1\">" . get_string('delete', 'local_saml_site') . '</a>';
